import org.techminds.jenkins.ConfigParser
import org.techminds.jenkins.models.BuildConfig
import org.techminds.jenkins.models.JobConfig

import static org.techminds.jenkins.ConfigParser.getCommonBasePath
  ...
  - name: kaniko
    ...
    resources:
      ...
      limits:
        ...
        cpu: "1500m"      
  - name: git
    image: docker.io/gajentechm/builder:2-64da60a1-version_script_update-NA
    imagePullPolicy: IfNotPresent
    command:
    - cat
    tty: true        
